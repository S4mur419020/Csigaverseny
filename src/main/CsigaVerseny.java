    ...
    void Start() {
        ...
        for (int i = 0; i < KOROK_SZAMA; i++) {
            ...
            for (int j = 0; j < csigak.length; j++) {
                ...
                System.out.println(" "+ "Aktuális pozicio: "+AktPozTomb[j]+" "+csigak[j].getSzkod()+" "+csigak[j].getIkon());
        ...
        System.out.println("A nyertes: "+AktPozTomb[nyertesi]+" "+"a távolságal"+csigak[nyertesi].getSzkod()+" "+csigak[nyertesi].getIkon());
